...
; Setup interrupts
  ...
  outputString "Floppy disk control program",10
...
resetFDC:
  mov dx,0x03f2
  mov al,0x18  ; Motor A off, DMA/INT enabled, FDC reset, drive=A
  out dx,al
  mov al,0x1c  ; Motor A off, DMA/INT enabled, FDC not reset, drive=A
  out dx,al
