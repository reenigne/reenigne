...
int8_isav0:
  ...
  push dx
  mov dx,0x3d4
  mov ax,0x3806 ;0x3206 ;
  out dx,ax
  mov ax,0x4104 ;0x3b04 ;
  out dx,ax
...
%endif
  ...
  ; Final 0a - scanline 100
int8_isav0a:
  push ax
  push dx

  mov dx,0x3d4
  mov ax,0x0008  ; Set interlace mode to non-interlaced
  out dx,ax
...
int8_isav0b:
  ...
  mov ax,0x0308  ; Set interlace mode to ISAV
  out dx,ax
  mov ax,0x0309  ; 4 scanlines per row
  out dx,ax
