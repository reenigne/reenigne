...
;  safeRefreshOff
  ...
  out dx,ax
  mov ax,0x0009  ; Maximum scanline address
  out dx,ax
  mov ax,0x060a
  out dx,ax
  mov ax,0x070b
...
;  mov ax,(76*263) & 0xff        ; We're still counting down from adjustPeriod
;  out 0x40,al
;  mov al,(76*263) >> 8
;  out 0x40,al
  mov ax,(76*224) & 0xff        ; We're still counting down from adjustPeriod
  out 0x40,al
  mov al,(76*224) >> 8
  out 0x40,al
  mov ax,cs
